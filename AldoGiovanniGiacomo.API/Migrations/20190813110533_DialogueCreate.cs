...
{
    public partial class DialogueCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Dialogues_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, @"Giacomo [al telefono con Giovanni]: Pronto? 
                ...
                Giovanni: Vabbe'... sette e un quarto. Ciao!", 1 },
                    { 112, @"Giacomo: Comandante, tenterei di stabilire un contatto con queste forme aliene. Potrebbero darci una mano a risalire sull'Enterprise. 
                ...
                Irina [Con accento russo]: Eh, nel suo caso è morto, eh comandante!", 7 },
                    { 113, @"Giacomo: Comandante, muschi e licheni chiedono di parlare con l'interlocutore più qualificato.
                ...
                Silvana: Ma va? 
                Giacomo: Vuol vedere la bacchetta magica?", 7 },
                    { 116, @"Giovanni: Tipo, ce li hai dieci euro? Sai... per i cani... 
                ...
                Silvana: Eh no, eh, perché non ho il giardino...
                Giacomo: Ma voi due vi siete conosciuti a San Patrignano? Eh?", 7 },
                    { 117, @"Silvana: Senta lei, scusi se mi permetto, ma lo sa che non si danno calci ai cani?
                ...
                Silvana: Eh no, eh, perché non ho il giardino... 
                Giacomo: Che cazzo sarà? Le polveri sottili... cosa sarà?", 7 },
                    { 118, "Giacomo: [A Giovanni che barcollando, stava rischiando di cadere e viene sorretto da Silvana appena in tempo] Senta, ma lei è a digiuno o a pieno regime così?", 7 },
                    { 119, "Giacomo: [Ad Aldo che non si muove a prelevare i soldi.] Senta! Lei sta scrivendo \"Guerra e pace\"? Eh?", 7 },
                    { 120, @"Aldo: Oh, dovreste farmi tutti un favore! Scusate, lì dietro... Allora, dovremmo fare tutti una cosa insieme. Siccome qui c'è una gazza ladra addestrata a portare via i soldi al malcapitato... ed è capitato. Allora, per evitare che questa qui plana, agitiamo tutti le mani, così questa qui si spaventa e non plana. Avanti, facciamolo, dai! Forza, tutti insieme. Agitiamo le mani. [Silvana e Giovanni lo fanno, mentre Giacomo sta con le braccia incrociate.]
                Silvana: Senta, scusi, ma agiti le braccia, che cosa le costa?
                Giacomo: [Le agita con malavoglia] Tanto la mattina è andata a puttane!", 7 },
                    { 121, @"Silvana: [Aldo ha finalmente finito di prelevare e Giacomo passa davanti al bancomat.] Scusi eh, forse non si ricorda, ma c'ero prima io davanti a lei!
                Giacomo: Ha ragione, ma... incameri l'energia di Nettuno e Plutone, faccia un soffritto ayurvedico, liberi due o tre chakra e si tolga dalle palle! Va bene?", 7 },
                    { 122, @"[Giovanni e Giacomo parlano dietro le quinte, mentre Aldo compare in scena e osserva un quadro] 
                ...
                Aldo: Che è monocromatico...", 7 },
                    { 123, @"Giacomo: [Vedendo Giovanni sedersi su una sedia] Ma sei scemo Giovanni? Sei cretino? Hai rovinato una scultura di Fistalloni!
                ...
                Giovanni: Sì, la corrente alternata...", 7 },
                    { 124, @"Giovanni: Cioè quella lì non è una sedia, e questo è un estintore?
                ...
                Giovanni: Ma vaffanculo! [Tirando un calcio all'estintore vero che credeva essere la rappresentazione di un estintore]", 7 },
                    { 125, @"Giacomo: Venite... Venite qua... Mettetevi di fianco a questo quadro, che è considerato il capolavoro del museo. Osservatelo bene, dopodiché: che cosa ne dite?
                ...
                Aldo: Non cercare scuse!", 7 },
                    { 126, @"[Davanti a una cornice vuota, in cui Giovanni infila la mano]
                ...
                Giovanni: Cioè lui non ha fatto un cazzo, ha detto ""tanto la gente poi ci vede quello che vuole"", e io me ne lavo le mani...", 7 },
                    { 127, @"[Davanti alla cornice vuota] 
                Aldo: Ma questo va visto da vicino o da lontano?", 7 },
                    { 128, @"[Aldo si è incastrato in una statua, e prova ad attirare l'attenzione di Giovanni e Giacomo] 
                ...
                Giacomo: La tua idiozia ti ha spinto!", 7 },
                    { 111, @"Giacomo: [Il robot ha detto di aver individuato, tramite il rilevatore puntato verso il pubblico, che le forme vitali presenti sul pianeta si stanno muovendo] Comandante, non si allarmi, non sono ostili! Sono solo molto curiosi!
                ...
                Giovanni: Eh per forza, lo sta puntando verso il primo ufficiale! Non è che possiam pretendere!", 7 },
                    { 110, @"Giovanni: Primo ufficiale, com'è questo pianeta? Ditemi. 
                ...
                Aldo: Organismi monocellulari, brodo primordiale... e anche se si evolgono più in là della muffetta non vanno...", 7 },
                    { 109, @"[Giovanni entra in scena affaticato spingendo un'enorme palla, la biosfera] 
                ...
                Giacomo: Sarà un piacere prendere a calci questa palla di merda! [Prende a calci la palla di biosfera dietro le quinte]", 7 },
                    { 108, @"Aldo: [via radio] Rientriamo alla base per analizzare meglio i dati. Testa di latta [A Giacomo], mettiti qua. [via radio] Mandate pure il raggio teletrasportatore. [Il raggio appare in una posizione sbagliata, alla loro destra.]
                ...
                Aldo: Aaaah, ma perché parla tanto? [via radio] Avete sbagliato di nuovo ma lasciate il raggio lì dov'è, che ci saltiamo dentro noi... sennò facciamo notte, in inglese fahrenheit!", 7 },
                    { 90, @"Jack: Allora, Al, ascoltami bene: era venerdì. Eravamo al Drive In di Coney Island. Eravamo lì perché il boss...
                ...
                Jack: E allora fai una cosa, Al: ascolta il professorone. [indica John e se ne va]", 5 },
                    { 91, @"Al: Ma... ditemi un'ultima cosa... quello che mi avete raccontato... è tutto inventato?
                ...
                John: [annuisce] Sarebbe stato bello...", 5 },
                    { 94, @"Aldo: Buongiorno! Dove andiamo di bello? 
                ...
                Aldo: Ah! Questo è il Bolero?! Questo è il Bolero?! Vabbe'... Un attimo che impostiamo il navigatore, perché un conto è chi è Wagner e un conto è dov'è Wagner! ... Wagner si scrive con la G di Goethe?", 6 },
                    { 95, @"Claudia: Senti, ma perché stasera non andiamo a mangiare fuori? Una cosa semplice eh, una pizza. 
                ...
                Giovanni [contento]: Dai!", 6 },
                    { 96, @"Claudia: Ma scusa, non guardi Passaparola? C'è la ruota finale... [Giovanni la interrompe] 
                Giovanni: Ma chi se ne frega di Passaparola! Lo sto registrando!", 6 },
                    { 97, @"Giovanni [dopo che Claudia chiude una chiamata]: Chi cazzo era a quest'ora? 
                ...
                Claudia [perde la pazienza]: Senti: è tardi, sono stanca e non ne voglio parlare! Lasciami dormire. Buonanotte.", 6 },
                    { 129, @"Giacomo: [Su tutte le furie, riguardo ad Aldo, incastrato in una scultura] Guarda, ti ammazzerei di botte, ti ammazzerei! 
                ...
                Giovanni: Ma prima avevi detto che ti avevano spinto!", 7 },
                    { 98, @"Claudia: Ma ti rendi conto che [si riferisce a Giovanni] è stronzo!? Io mi spacco la testa per cercare di salvare 'sto cazzo di matrimonio e lui cosa fa??? Che pezzo di merda...
                ...
                Claudia [inizia a piangere]: Allora vuol dire che deve finire così... [si asciuga una lacrima con la mano]", 6 },
                    { 100, @"Aldo: Allora com'è andata ieri notte?
                Giovanni: Mah, niente.
                Aldo: È andata male?
                ...
                Giovanni: Ma perché, non ti ha detto niente il tuo amico?", 6 },
                    { 101, @"Navigatore: Percorrere questa strada per settecentonovantanove chilometri. [passa un minuto] Percorrere questa strada per settecentonovantotto chilometri.
                ...
                Aldo: Dicevi così anche di tua moglie.", 6 },
                    { 102, @"Navigatore: Tra cinquecento metri svoltare a destra. Tra quattrocento metri svolt...
                ...
                Giovanni: Ma no, è impossibile: non ce l'abbiamo il solaio. [Aldo lo squadra] Cioè: ce l'abbiamo, però le chiavi ce le ha il vecchio inquilino e quindi... [Aldo lo squadra di nuovo] Oddio... Adesso mi fate venire un dubbio...", 6 },
                    { 103, @"Giovanni: Sì ma quando cacchio arriva 'sto carro attrezzi?
                ...
                Giacomo: Botta di culo, eh?", 6 },
                    { 104, @"Vanni Maceria: Bimbi, c'ho una bella notizia per voi: avete spappolato il carburatore! È tutto ""sgarganato""!
                Aldo: Che ha detto?
                Giacomo: Carburatore.
                ...
                Vanni Maceria: Oh, [indica l'orologio] è alta stagione esagerata! Ma lo sapete come si dice dalle mie parti? «Chi per la fretta caca nell'ortica, spesso il culo gli formica!» [proverbio]", 6 },
                    { 105, @"Aldo [preoccupato]: Che ci faccio qui? Che ci faccio qui?? Che ci faccio qui? Che ci faccio qui, Giacomino?
                ...
                Aldo [cerca di smettere di piangere]: Eravamo al fast food io e Claudia... [si rilassa] Avevamo appena finito di fare l'amore. E tu, Giacomino, mi insegni che dopo aver fatto l'amore niente è meglio di un Big Mac...", 6 },
                    { 106, @"Aldo: Ah! Quasi dimenticavo... per la corsa sarebbero tremilaseicento euro.
                Giacomo [strabuzza di colpo gli occhi e lo squadra]: Come tremilaseicento euro?!?
                Aldo: Ah, gia: cappuccio e brioche... Quelli li offro io... Che vuoi? Sono fatto così. Chiamami scemo... chiamami ""unplugged"", ma sono fatto così...", 6 },
                    { 107, @"Aldo: [parlando via radio] Primo ufficiale Enterprise, abbiamo informazioni rilevanti dal pianeta sconosciuto. 
                ...
                Aldo: Guarda che ti smonto e ti rimonto a immagine e somiglianza di un frullatore! E adesso che ti guardo bene, ci guadagni!", 7 },
                    { 99, @"Giovanni: E allora sai cosa faccio? Adesso vado lì, e a questa domanda deve rispondere: o lui o me. Capito? 
                Giacomo: A parte che tecnicamente non sarebbe una domanda... Comunque, ho capito.", 6 },
                    { 130, @"Giovanni: Ma sei sce... Ma dove guardavi, hai fatto la puntura a me! 
                Giacomo: Ma scusa, ti metti lì davanti! 
                Giovanni: Ma non distingui il culo? 
                Giacomo: Ma Giovanni, il culo è culo. 
                Giovanni: E no, c'è culo e culo: pensa a Dolce e Gabbana!", 7 },
                    { 131, @"Aldo: Ha visto com'è stata veloce la funzione signora, sono diventato cardinale or ora. 
                Signora: Perbacco. 
                ...
                Aldo: Mi può passare tutt'e due per cortesia?", 7 },
                    { 132, @"Giovanni: [Mentre Aldo cerca di rubargli il motorino] Uè, Nino, cosa stai facendo? Uè! Vieni giù dalla moto! Allora! Porca vacca, stavi cercando di rubar la moto, eh? 
                Aldo: Sono un collezionista. 
                Giovanni: Eh, so io che cosa collezioni tu, va là!", 7 },
                    { 156, @"[Dopo aver assistito a una pallonata dei bambini sulla sua macchina] Eh no, eh! Eh no, eh no, eh no, eh! Guardate che ve lo buco quel pallone!
                ...
                Aldo: Trentasei euro al chilo? Rita, ma sei matta?! Io mi spezzo la schiena in due e tu mi sperperi tutto il patrimonio? Ho un tenore di vita da Tronchetti Provera senza capitale e quella mi spende come Afef!", 8 },
                    { 157, @"Padre Bruno: Io ti assolvo nel nome del Padre, del Figlio e dello Spirito Santo, Amen. 
                ...
                Mario: Quella donna ha messo le corna al marito e se la cava con tre Ave Maria?", 8 },
                    { 158, @"Mario [parlando con Padre Bruno dell'importanza della confessione]: Ma io ho tanto bisogno di Dio... 
                ...
                Mario: Come passa il tempo...", 8 },
                    { 159, @"Mario: Già che è qua, Padre, ma la resurrezione riguarda solo l'anima o anche il corpo? 
                ...
                Padre Bruno: Nel tuo caso sarebbe meglio che tu rinascessi con un corpo diverso!", 8 },
                    { 160, @"Beniamino [confessandosi]: Sono confuso, non ho dormito tutta la notte!
                ...
                Beniamino: Troppi.
                Padre Bruno: Troppi?!
                Mario: Non sono mai troppi i soldi, Padre!", 8 },
                    { 161, @"Beniamino: Biscotti e vin santo? 
                ...
                Beniamino: Ricchi di fibre, cereali, e frutta secca!", 8 },
                    { 162, @"Aldo: Ora provo il giro della morte! 
                Giacomo: Ma no, non lo fare! 
                Giovanni: Ci ha già provato il Conte di Montecristo, hai visto che cosa gli è successo? L'hanno rotolato dentro una tela e rinchiuso in uno sgabuzzino!", 8 },
                    { 163, @"Aldo: Je suis un cavalier! 
                Giacomo e Giovanni: Cavaliere? 
                Aldo: Oui? 
                Giacomo e Giovanni: Prrrrrrrrrrr!", 8 },
                    { 155, @"Giovanni: E dai, dì qualcosa anche tu, cosa ti piace? [del posto dove si stanno recando in vacanza] 
                Moglie di Giovanni: Cosa mi piace? Il viaggio di ritorno. 
                [Giovanni improvvisamente frena] Giovanni: Eh no, eh! Non si parte con questo spirito! [Tutti quanti esultano] Questo è lo spirito giusto, bravi! [Riparte con la macchina]", 8 },
                    { 164, @"Giovanni e Giacomo: Napoleon? 
                Napoleone: Oui? 
                Giovanni e Giacomo: Prrrrrrrrrrr!", 8 },
                    { 166, @"Dott.ssa Gastani Frinzi: Hmm, no. Lo spermiogramma non ci dà delle belle notizie, hmm... La maggior parte degli spermatozoi è morta. I rimanenti possiedono una motilità scarsissima, direi. Desidera un caffè?
                ...
                Dott.ssa Gastani Frinzi: Glielo spiego in altre parole: questi spermatozoi sono stanchi, sono deboli, non hanno proprio il vigore, non possono raggiungere l'obiettivo, non so come dire... sono impigriti, svogliati, sa, proprio senza nerbo... sono... poco motivati, poco motivati. Ma come mai, signor Poretti?", 8 },
                    { 167, @"Moglie di Giacomo: Ma non c'è proprio niente che possiamo fare? 
                D.ssa Alexandra Gastani Frinzi: Si un paio di cose: o cambiare partner... ahahah, no, scherzavo, dai, scherzavo, non si intristisca, già questi sono depressi...", 8 },
                    { 168, @"Aldo: Mio figlio... si fa le canne...
                Giovanni: Eh, col padre che si ritrova è un miracolo che non faccia lo stupratore...
                Aldo: Forse commette anche quel reato...
                Giovanni: Allora facciamo che da oggi non ci conosciamo.", 8 },
                    { 169, @"Dott.ssa Gastani Frinzi: Signor Poretti! Lei si è applicato? 
                ...
                Giacomo: Ah, perché ti devo anche pagare? Ma vaffanculo va!", 8 },
                    { 170, @"Giovanni: Hai visto che gol di sinistro? Proprio sotto la traversa...
                Aldo: Lo avrebbe fatto anche mio nonno!
                Giovanni: Ma se è morto!
                Aldo: Appunto. Mi passi lo shampoo?
                Giovanni: E che cazzo te ne fai?", 8 },
                    { 171, @"Aldo [parlando di suo figlio]: Si è fatto bocciare. Che vergogna. 
                Giacomo: Ma chi? 
                Aldo: Il maggiore. 
                ...
                Giovanni: Ecco, in questo caso sarebbe proprio il primo dell'albero.", 8 },
                    { 172, @"Irene: C'è qualche terrone qui? [Giovanni e Giacomo fissando Aldo]
                ...
                Irene: Sei tu, sei tu che hai avuto la brillante idea di farvi beccare proprio stasera, eh?! Ma che razza di banda siete??", 9 },
                    { 173, @"Giacomo: T'ha cacciato a pedate nel culo? 
                Aldo: Ho avuto un misunderstanding! 
                Giovanni: Cosa?! 
                Aldo: Un pacato confronto tra persone adulte...", 9 },
                    { 165, @"Giacomo: Com'è che si chiama [il figlio di Giovanni]?
                Moglie di Giacomo: Saturnino.
                Giacomo: Ma che nome è?
                Moglie di Giacomo: È il nome del nonno.
                Giacomo: Se il nonno si chiamava Nosferatu, chiamavano il bambino Nosferatu?", 8 },
                    { 89, @"Boss: Ora lancerò questi dadi, forza, ditemelo un numero! Se uscirà proprio quel numero avrete salva la vita. Avanti, qual è il vostro numero fortunato, eh? 
                ...
                John: Scusi per l'interruzione, boss!", 5 },
                    { 154, @"Suocera di Aldo: Solo tu potevi sbagliare macchina, guarda!
                ...
                Suocera di Aldo: Omosessuale, no? Vieni da nonna, dai!", 8 },
                    { 152, @"Moglie di Giovanni: Che fai, non saliamo?
                ...
                Moglie di Giovanni: Mamma mia...", 8 },
                    { 133, @"Giacomo: Allora, Mozambico? 
                Aldo: Sono un collezionista. 
                Giacomo: Cosa colleziona, avvisi di garanzia?", 7 },
                    { 134, @"Giacomo: Con questo lei cosa vorrebbe dire? Che ci sono cittadini di serie A e cittadini di serie B secondo lei?
                Giovanni: Mah, se lo guardiamo bene in faccia, lì siamo C2 zona retrocessione!
                Giacomo: Ahhh, un razzista!", 7 },
                    { 135, @"Aldo: Meno male che forse sono italiano! Sono di Gela.
                ...
                Giovanni: Ma non è mica una banana!", 7 },
                    { 140, @"Giacomo: [Guarda inorridito le chiavi della moto di Giovanni] Non mi dica che queste...
                Giovanni: Sì, son le palle del gatto... le ho fatte mummificare perché c'ero affezionato... Deve vedere il gatto, se le lecca ancora! Fa... [Imita il gatto] poi si accorge che non ci sono e fa una faccia tutta... sto pensando di riattaccargliele per dargli fiducia!", 7 },
                    { 141, @"Aldo: Ah, senti che aria pulita! Respira a pieni polmoni.
                ...
                Aldo: No, è l'Etna! 
                Giovanni: L'Etna! Che tersitudine che c'è oggi!", 7 },
                    { 153, @"Suocera di Aldo: Le gomme anteriori sono sgonfie, eh!
                Aldo: Embé?
                Suocera di Aldo: Embé, non è sicuro!
                Aldo: Le ho sgonfiate apposta! Metti che passiamo sotto un cavalcavia troppo basso, che faccio, scendo e sgonfio le gomme?", 8 },
                    { 142, @"Giovanni: Trenta piani quanto sono in misura?
                ...
                Aldo: Se facevamo la staffetta 4x4, misuravamo in metri, siccome stiamo facendo jumping si misura in foot, massimo in yard!", 7 },
                    { 144, @"Aldo: Peppino! Come la va la famiglia? [Peppino comincia a piangere] 
                Giovanni: Ma se è in affido non ce l'ha la famiglia, no?! Ma sei deficiente?!", 7 },
                    { 145, @"Aldo: Peppino! Chissà quante ne hai da raccontare ai tuoi nipoti... [Peppino piange] 
                ...
                Aldo: E che ne so io!!!", 7 },
                    { 146, @"Giacomo: Eran quattro Fenici di merda che se li incontro... BAM! 
                Aldo: [Ironico] Fenicità! No... dico... ""Fenicità"" cioè... è Napo-Napo-Napo-Napoletano... 
                Giacomo: Ma le spieghi anche le cagate che dici?!", 7 },
                    { 147, @"Aldo: Ascoltami... quella è la capanna dello zio Tom. e qui, tra il Tigri e l'Eufrate devi stare attento che non entri nessuno. Se per caso entra qualcuno, chiedi la parola d'ordine... 
                Giacomo: Password. 
                Aldo: No, la decidiamo insieme, non è che devi decidere da solo. Per esempio ""La parola d'ordine..."" 
                Giacomo: Password! 
                Aldo: La parola d'ordine è... 
                Giacomo: Password! 
                Aldo: Ahh, ""vaffanculo""! La decido io, e basta, e che è, la deve decidere lui ? !", 7 },
                    { 148, @"Aldo: [Preoccupato perché gli sembra che Peppino gli abbia infilato il tappino del bastone nel sedere toccandolo] Peppino... c'era il tappino prima nel bastone? 
                Giacomo: Certamente! 
                Aldo: Ho paura a chiederlo... e che fine ha fatto? 
                Giacomo: Inside your body! 
                Aldo: [Guarda Giovanni] Non so l'inglese, ma credo di aver capito... Se mi muovo con cautela non lo sento, ma se mi muovo shakerando lo sento...", 7 },
                    { 149, "Giacomo: [Alla caduta di Aldo dal tetto del palazzo] Uno di meno!", 7 },
                    { 150, @"Aldo: [Giovanni si prepara a saltare giù, e Aldo fa il conto alla rovescia] Allora.. UNO... sgombra la mente... DUE... sgombra la mente... TRE... [Si ferma all'improvviso] EH OH! FERMATI!!! 
                Giovanni: Cosa c'è?! 
                ...
                Giovanni: [A Giacomo, terrorizzato] L'ha visto fare, non l'ha mai fatto!", 7 },
                    { 151, @"Aldo: [Peppino non torna su e Aldo tira la corda a sé] È molle! 
                Giovanni: È molle? 
                Aldo: È leggero... 
                ...
                Giovanni: [Guarda la gamba di Peppino e si ricorda] Ecco qual era l'altra malattia che non mi ricordavo! Osteoporosi!", 7 },
                    { 143, @"Giacomo: [Col fiatone] Ho fatto trenta piani a piedi... 
                Giovanni: È dura, eh? 
                ...
                Giacomo: È bello profondo, eh! Porca troia, saran cento foot!", 7 },
                    { 88, @"Boss: Dovevate ammazzare una spia... e avete ammazzato un barbiere... non so proprio più come fare con voi, ragazzi... due settimane fa avete chiesto il pizzo ai negozi sbagliati... e oggi mi ammazzate un barbiere!! 
                Jack: Eh, poi ci sarebbe anche la storia del bourbon... 
                Boss: Quale bourbon? 
                Jack: Eh quella partita di bourbon che dovevamo consegnare, e invece... ci siamo scolati al party di Billy Piorrea.", 5 },
                    { 87, @"John: Sei contento?
                ...
                Jack: E hai scelto il Carabbaggio...?! [John annuisce, e Jack si scandalizza] Che compleanno di merda! [lancia la pistola sul tavolo]", 5 },
                    { 86, @"John: Forse m'è venuta un'idea... 
                Jack: Gazpacho con la cocaina?! [John gli dà uno scappellotto]", 5 },
                    { 24, @"Chiara: E così domani ti sposi? 
                Giacomo: Sì, ma niente di serio.", 1 },
                    { 25, @"Giovanni [rivolto ad Aldo che ha appena gettato la ruota di scorta nel fiume, che però non regge]: Ma sei deficiente!?
                Aldo: Eh, mi credevo che galleggiava...
                Giovanni: Ma se solo il cerchione pesa trenta chili!", 1 },
                    { 26, @"Jack: Se al mattino spacchi le pietre, al pomeriggio scavi le buche. Se al pomeriggio si spaccano le pietre, al mattino si scavano le buche. Se al mattino... 
                Al: Se al mattino spacchi le palle, la sera pure! 
                Jack: Ma che minchia di programma rieducativo è?", 2 },
                    { 27, @"Al [raccontando una barzelletta]: C'è un tipo di colore...
                ...
                Jack: L'elefante che parla inglese! Johnny, sei veramente una bomba, sei! [...] Ma come finisce 'sta barzelletta?", 2 },
                    { 28, @"Giacomo: Ciao. Cosa stai leggendo oggi? 
                ...
                Cognato di Giacomo: Ahò! Ah Malcolm X! Intanto stai carmo te. Primo. Secondo: famo 'na bella cosa; al posto di ""unanimità"", ce scriviamo: ""Voti favorevoli: 15; voti contrari: 1"". Er tuo, eh? Giacomino, l'amico dii negri. Ciao, Congo.", 2 },
                    { 29, @"Giovanni: Io avevo un appuntamento importantissimo! 
                Giacomo: Sì, dal pediatra.", 2 },
                    { 30, @"Giacomo: Anzi! Se proprio vuoi saperlo, io il poliziotto non volevo neanche farlo. È capitato. 
                Giovanni: Eh, e se non capitava era meglio!", 2 },
                    { 31, @"Giacomo: Sai com'è la vita, capitano delle cose più grosse di te e devi prendere delle decisioni, un po' come il bivio di prima, ti ricordi, ""Che faccio? Vado a destra o vado a sinistra?"" E lì se non stai attento rischi di sbagliare, rischi di prendere la strada sbagliata. 
                Giovanni: E tu l'hai presa in pieno, contromano!", 2 },
                    { 23, @"Aldo: Ragazzi! Ragazzi! Ho trovato il nuovo Ringhio!
                Giovanni: Ma se è nero!
                Aldo: Ma perché, devi essere razzista anche coi cani?", 1 },
                    { 32, @"Giacomo: Tra l'altro ho anche finito di scrivere un romanzo. 
                Giovanni [sarcastico]: Non vedo l'ora di leggerlo, c'ho l'acquolina in bocca.", 2 },
                    { 34, @"Aldo: Pronto, chi è? Chi? Giovanni Storti? E lei chi è? Ah, è la moglie.
                Giovanni: Mia moglie.
                Aldo: Stai fermo con le mani! Non lo so se ha sbagliato numero ma sicuramente ha sbagliato persona, o forse ha sbagliato numero ma ha trovato la persona giusta, o ... mi'! M'ha mandato a fanculo! Lo stesso carattere del marito! Mi', che famiglia! Sequestrato... anzi eliminato! [Riferito al telefonino che butta dal finestrino]", 2 },
                    { 35, @"Catania: Minchia già incazzato?? 
                ...
                Catania: Non far lo stronzo... Giacomo ti prego non far lo stronzo! Io sto mettendo la mia vita nelle tue mani e tu fai lo stronzo? Non lo fare perché io per te... io per te... e dammi un bacio... quanto cazzo di bene ti voglio!", 2 },
                    { 36, @"Giacomo: Catania hai letto il regolamento? Non posso recuperare un delinquente da solo. 
                ...
                Catania: Allora ci vediamo qui alle undici.", 2 },
                    { 37, @"Aldo: Vuoi un po' di cheeseburger? 
                ...
                Aldo: Mii, e che devi farmi la cartella clinica?!", 2 },
                    { 38, @"Aldo: Ma perché? Perché, perché, perché mi fai questo? Perché mi devi mettere sempre i bastoni fra le ruote, eh? Mentre sto operando, oltretutto!
                ...
                Giacomo: Ci credo che non senti niente, deficienti! È ketchup! Hai assassinato il sacchetto d'hamburger, hai assassinato!", 2 },
                    { 40, @"Aldo [puntandosi la pistola alla tempia]: Datemi un buon motivo per non farlo.
                Giovanni: Be', adesso non me ne viene in mente neanche uno, però pensandoci bene, magari...", 2 },
                    { 41, @"Giovanni [riferendosi ad Aldo]: Oh cacchio, è con una ragazza?!
                Giacomo: Sì.
                ...
                Giovanni [ride]: Ma pubblico ufficiale che cosa, ma ti sei visto? Ma sei vestito come uno spaventa-passeri, e sai perché? Perché sei uno spaventa-passeri!", 2 },
                    { 33, @"Aldo: In Africa, tutte le mattine, quando sorge il sole, una gazzella muore. 
                Clara: Muore? 
                Aldo: Si sveglia già morta, perché si vede che non stava molto bene il giorno prima e allora... Comunque, sempre in Africa, no? Tutte le mattine, quando sorge il sole, un leone, appena si sveglia, comincia a correre per evitare di fare la fine della gazzella che è morta il giorno prima. E poi, correndo, vede che c'è la gazzella morta il giorno prima lì e visto che... ""Che cosa corro a fare? Mi fermo e gli do due mozzicate"". Comunque, dove voglio arrivare? Non è importante che tu sei un crotalo o un pavone. L'importante è che se muori, me lo dici prima.[1]", 2 },
                    { 42, @"Aldo: Ti chiami Clara?! Bellissimo nome! Pensa che quando ero bambino, e quando dico bambino... dico bambino! Conoscevo un'amica che si chiamava Francesca... E indovina come la chiamavo?
                Clara: Clara.
                Aldo: Eh no. Si chiamava Francesca... E la chiamavo Francesca.", 2 },
                    { 22, @"Giovanni: Lo sai che con venti milioni si può comprare un bar in Costa Rica? Sulla spiaggia. Sole, mare, un sacco di palme. 
                ...
                Aldo: Una volta: una volta ho messo due fisso a Inter-Cagliari.", 1 },
                    { 20, @"[In ospedale, Giovanni guarda fuori dalla finestra] 
                ...
                Aldo: Eeeeh, ragazzi, stiamo calmi, non è successo niente, vorrà dire che gli presterò il mio!", 1 },
                    { 2, @"Giacomo [verso la casa di Aldo]: Aldo! Aldo! 
                ...
                Giovanni [a Giacomo]: Peperonata? Alle otto del mattino? Mezzogiorno... topi morti?", 1 },
                    { 3, @"Portinaia: Signor Giovanni! Signor Giovanni! Buongiorno signor Giovanni... come sta la sua signora? È già giù al mare che l'aspetta, nè? Ma lei non è geloso? 
                Giovanni: Be'... 
                ...
                Portinaia: Eh, era ora che facesse qualcosa anche lei, eh! Così siete a posto tutti e tre, finalmente! A proposito, se non togliete la macchina lì davanti al portone immediatamente, io ve la faccio rigare da mio marito! E poi ve la faccio anche portar via dai vigili! Capito? Eheheh! [a Giovanni] Buon viaggio, nè! [a Giacomo] Buon viaggio anche a lei, nè!", 1 },
                    { 4, @"[Aldo ruba il posto in macchina a Giacomo proprio quando si sta sedendo]
                Aldo: Scusa! 
                Giacomo: Ma come 'scusa'? Arrivi, neanche saluti e mi ciuli il posto?
                Aldo: Hai ragione. Ciao, come stai? Andiamo Giovanni, che è tardi!", 1 },
                    { 5, @"Donna: Ma chi sono quelli là? 
                ...
                Portinaia: Certo! Sì, quello che ha quella grande catena di negozi di ferramenta, che se non fosse per lui, ti dico la verità, io ti assicuro che quei tre lì a quest'ora sarebbero in mezzo alla strada!", 1 },
                    { 6, @"[In macchina] 
                ...
                Giovanni: E pignolo!", 1 },
                    { 7, @"Giovanni: Allora io vado a prendere il pacco, tu... non so... vai a prendere...
                Giacomo: Scusa, ma possibile che quando c'è un lavoro di responsabilità devi farlo sempre tu? Cos'è, io non son capace?
                Giovanni: No. Però, se vuoi andare...", 1 },
                    { 8, @"Giovanni [parlando della scultura]: Cos'è 'sta roba? Scusate ma... centosettanta milioni per questa merdina qua? Ma dai, è una follia!
                Giacomo: Ma che follia, che follia!? Ma lo sai che questo qui è un Garpez, uno dei più grandi scultori viventi?
                Giovanni: Ma scultore che cosa? Ma guarda che il mio falegname con trentamila lire la fa meglio, va', non ha neanche le unghie!", 1 },
                    { 9, @"Cecconi: Lo sai come so' fatti 'sti artisti... Mezzi drogati, mezzi froci... ma comunque, se 'more, la gamba fa un sarto [salto], uno zompo, e va a trecento milioni! Ma che sto a di', a te, che nun capisci niente, su! Per piacere, a' nano [sarebbe Giacomo], e passame er pignolo [sarebbe Giovanni], và! Pronto, pignolo? Andò state?
                Giovanni: Eh, è poco che siam partiti, avremo fatto... quaranta chilometri!
                Cecconi: Aoh, 'a pigno', ma dovete sbrigarve, dovete còre! [correre] Perché stasera c'abbiamo una cena! Sì, siete tutti invitati ar Gambrinuse, ar ristorante! Così ve presento er prete. Oh, me raccomando, eh... nun me fate fa' figure de merda! Mi raccomando! [il cane Ringhio abbaia] Oh... oh, oh, sento Ringhio! Ah, ah, Ringhio, a papà, fa sentì 'a vocetta tua! [il cane Ringhio abbaia forte] Eheheh, meno male che ce sei te, Ringhio... eh, sei l'unico che me dà soddisfazione...", 1 },
                    { 21, @"[Vedendo Giacomo con indosso la maglietta che gli ha prestato Aldo]
                Giovanni: Sì, però, anche tu... ti sembra il caso di dormire con la maglietta di Sforza? 
                Aldo: Eh, quella di Ronaldo era finita! [Giovanni sbatte furiosamente Aldo dietro a testa la porta vetrata, che gli geme di dolore atroce]", 1 },
                    { 10, @"Giacomo: Scusa, puoi tirar su il finestrino? Lo sai che ho avuto problemi al trigemino quest'anno. [Giovanni chiude il finestrino ed accende l'aria condizionata] Ti dico di tirar su il finestrino, mi accendi l'aria condizionata? Ho già fatto tre bronchiti quest'anno! 
                ...
                Giovanni: Sì, ma se lo dicevi prima ci portavamo dietro il polmone d'acciaio! Eh cazzo!", 1 },
                    { 12, @"Giovanni: Senti, lega il mostro [il cane Ringhio] alla macchina, così ci fa anche la guardia. 
                Aldo: Ma perché, non può venire? 
                Giovanni: Chi, la merdina? 
                Aldo: Dammi qua, per l'amore della pace, va!", 1 },
                    { 13, @"Aldo: Ma quanti libri legge quello lì [Giacomo]? 
                Giovanni: Ma neanche uno! Ne compra cento al mese e non gliene ho visto sfogliare uno!", 1 },
                    { 14, @"Giovanni [Dopo che lui e Giacomo hanno visto che il cane Ringhio non c'è più]: Be', così è la vita...
                ...
                Giacomo: Certo che voi due siete proprio dei conigli, dai! Ma che paura dovete avere? Siamo delle persone civili o no? Lo si chiama e gli si spiega che è stato un incidente!", 1 },
                    { 15, @"Giacomo: Non sento nessun rumorino, a parte che ho appena avuto l'otite e non ci sento molto bene!
                Giovanni: Allora sei 'na discarica!", 1 },
                    { 16, @"Giacomo [parlando di Chiara]: Oh, però è carina, eh? 
                ...
                Aldo: Be', insomma, tutte le ragioni non ce le avevi!", 1 },
                    { 17, @"Giacomo [a Chiara]: Tutto a posto? 
                ...
                Aldo: Sì, insomma... Abbiamo un negozio di ferramenta... Cioè, non è che il negozio di ferramenta è nostro... noi ci lavoriamo come commessi, come galoppini, insomma, come... come... sì...", 1 },
                    { 18, @"[Nel cinema, mentre cercano il meccanico] 
                ...
                Aldo: Vado a prendere i popcorn!", 1 },
                    { 19, @"Dottore [rivolgendosi a Giacomo]: Dunque, vediamo, nome e cognome? 
                ...
                Aldo: Non è che ti puoi mettere a discutere col professore, è un professorone! Un professorone di stirpe, non è che si è inventato, sa quello che deve dire.", 1 },
                    { 11, @"Aldo: Oh! Ti fermi che devo fare pipì? 
                Giovanni: Eh, adesso mi fermo ogni due minuti perché devi far pipì? 
                Aldo: Va bene, allora ti piscio in macchina!", 1 },
                    { 174, @"Gualtiero: Certo che come giocatore sei proprio una merda! 
                Aldo: Ma se sei tu che mi hai suggerito il tris sicuro! Dicevi he Gazzaladra era più veloce di un Porsche e aveva l'argento vivo di un termosifone! Gualtiero...", 9 },
                    { 43, @"Giovanni: Hai capito?
                Aldo: Non sono mica sordo!
                Giovanni: Ciccio, quello è sentire, capire è un'altra cosa!", 2 },
                    { 45, @"Giacomo: Non mi vedi da tre anni e mi sbatti la porta in faccia!?
                ...
                Aldo [voce fuori campo]: Eppure, tre anni fa le cose erano molto diverse!", 4 },
                    { 68, @"Al: Johnny, vai dritto verso la discarica.
                Frankie: No, la discarica no! Lo so che cosa succede alla discarica!
                John: E che cosa succede alla discarica, Frankie? Che si butta la spazzatura!", 5 },
                    { 69, @"John: E vabbè va', oggi mi sento di buon umore. Frankie, se risponderai a una domandina facile facile, te ne torni a casa dai tuoi bambini, eh?
                ...
                John: Ahi, ahi, ahi, che peccato, che peccato, che peccato, Frankie! Tra l'altro potevi dire una cosa qualsiasi che a noi andava bene! Chi minchia la sa la capitale della Birmania, Frankie?!", 5 },
                    { 70, @"Al: ...Ooh, non sai quale cosa si può fare, Johnny...? ...Non lo possiamo mandare a casa? [Frankie Culo di gomma]
                ...
                Al: E che problema c'è? Ammazziamo un cerbiatto e gli portiamo il suo cuore al boss. ...non avete visto Biancaneve e i sette nani?", 5 },
                    { 71, @"[Dopo aver ucciso il presunto Frankie Culo di gomma]
                John: Scusa Al, ma... non avevi detto che volevi salvargli la vita?
                Al: Sì, Johnny... E dove minchia lo troviamo un cerbiatto a New York?", 5 },
                    { 72, @"John: Allora, vediamo domani. Ore 4: far saltare la tintoria dei Jefferson. E mi raccomando Jack, non come l'altra volta che ti sei dimenticato il numero e hai fatto saltare un negozio a caso!
                Jack: Sì, però poi era quello giusto!
                John: Quella è fortuna, non si lavora così, siamo professionisti!", 5 },
                    { 73, @"Al: Ti sento, Diavolo, che sei in questa casa! Entra in me! Entra in me, Diavolo! Satana di un satanasso! Io ti scaccio-da questa-casa-male-detta!! Io ti posso affrontare! Hai capito?! Vai via, Satana!!
                ...
                John: Jack! Jack! Jack!
                Jack: Comunque faceva ridere, di' la verità!", 5 },
                    { 74, @"Jack: Ma come facevi a sapere che mi piaceva proprio la pistola? 
                Al: Eh, tu tre gusti hai! La pistola, le anfetamine e la torta di Melissa.", 5 },
                    { 75, @"John: Jack, quante volte te lo devo dire, non si spara ai cani! 
                Jack: E perché? 
                John: Perché sono animali superiori! 
                Jack: E chi l'ha detto? 
                John: Ma la scienza lo dice, Jack, la scienza! 
                Jack: La scienza? 
                John: Ma che ne sai tu di scienza!", 5 },
                    { 67, @"Al [vedendo ridere John e Jack]: Che c'è da ridere?
                John: Niente, Al...
                ...
                Jack: Mii, che clima... E come si fa ad ammazzare la gente con questo clima? Che siamo, delle macchine?", 5 },
                    { 76, @"John: [Jack spara alcuni colpi in aria per la casa] Ma che fai, Jack? Che fai? 
                ...
                Jack: Cinque? 
                John: No, sette! 
                Jack: Minchia, non mi sta in testa...", 5 },
                    { 78, @"Al: [Vede Jack che prende una statuetta di ceramica da sopra la TV] Jack, non mettere le tue mani appiccicose dappertutto!! Lascia stare le cose dove stanno, perché sono cose delicate, hai capito? 
                ...
                Jack: [Confuso, rimette la statua al suo posto] L'arte, non la capirò mai...", 5 },
                    { 79, @"Al: Non preoccuparti, io non voglio immischiarmi nelle vostre cose, ti chiedo solo di parlargli e di dirli che non sei innamorato di lui... se è così...
                ...
                John: Al, se dici un'altra volta ""se è così"" ti sparo in testa! È così!", 5 },
                    { 80, @"Jack: Johnny, però non è che te la puoi pigliare sempre con me, eh? E comunque che credi che io non ci abbia pensato? 
                John: Pensato! Jack, ma non ti si è ancora chiusa la fontanella, che vuoi pensare?", 5 },
                    { 81, @"Jack: Johnny, stai calmo, dammi retta, che con la calma si ottiene tutto... allora Al, ascoltami bene, eh, è facile: adesso tu esci da quella finestra, ti arrampichi sul cornicione ed entri nella stanza di Sam Genovese. 
                ...
                Jack: Che c'entra? Quello è perché ci puzzano le mani.", 5 },
                    { 82, @"Al: [Mentre percorre il cornicione rischia di cadere giù ma si riattacca al muro] Gesù... Perché proprio io?
                ...
                John: Che sono cretino, Jack? Ho bloccato l'ascensore!", 5 },
                    { 83, @"Al: [È arrivato alla fine del cornicione ma ha paura a saltare sul traliccio dell'insegna dell'albergo] Ho paura, non ce la posso fare!
                John: È facile Al, c'è il traliccio, è facile!
                Al: Io torno indietro!
                Jack: E salta, Al! Che devo fare, ti devo sparare??", 5 },
                    { 84, @"John: Non è successo niente, Al, bravo, non è successo niente... 
                Al: Mii, non è successo niente? E che doveva succedere, doveva cadere il palazzo?!", 5 },
                    { 85, @"John: E poi portare in giro per la città la zia di Sam Genovese è un grande onore. 
                ...
                Al: [Ironico] E allora andiamo a prendere questa teenager.", 5 },
                    { 77, @"John: [La zia di San Genovese muore uccisa davanti ai suoi occhi, e girandosi guarda Jack che è sotto shock] Ma Jack, che hai fatto? 
                ...
                Jack: Cinque! 
                John: No, sette! 
                Jack: Minchia, non mi sta in testa, Johnny!", 5 },
                    { 44, @"Giovanni [discutendo sulla reazione dei parenti alle loro morti]: Ma sì... Il discorso di fondo è uno solo: non è che tutti gli esseri umani di fronte al dolore hanno la stessa reazione. Non so, prendi una vedova araba: urla, strepita, si strappa i capelli, si rotola... Una svedese no! Al massimo una lacrimuccia. Non è che soffra meno, è una reazione diversa di fronte al dolore. Mia moglie ha avuto una reazione di questo tipo.
                ...
                Giovanni: Wè Giacomo, piano con le parole eh! Ahahahah, questa è bella! Mia moglie è un puttanone! Ma dai, mi fai ridere mi fai, ecco cosa mi fai! Adesso mia moglie è un puttanone... Ma pensa te! Mia moglie è un puttanone... [Con tono sempre più convinto] Mia moglie è un puttanone...", 2 },
                    { 66, @"John: Che stai facendo, Jack? Che stai facendo?
                ...
                John [esegue alcune mosse per far concludere la partita]: Partita finita.", 5 },
                    { 64, @"Giacomo: Giovanni, ma sono fasi del rapporto queste qua. 
                ...
                Aldo: Giacomino, anche tu, sei bravissimo a scarricare, ma per riconciliare una coppia sei una merda proprio!", 4 },
                    { 46, @"Aldo: Oh, eh, Giovanni, quando vuoi venire non ti fare scrupoli, eh? Questa casa è sempre aperta per te. Eh? Non ti fare scrupoli, vieni quando vuoi, hai capito?
                ...
                Giovanni: Allora, no, no, no, un attimo! Mettiamo le cose in chiaro!", 4 },
                    { 47, @"Giacomo: Allora, stavolta mi è proprio venuta una grande bella idea: e se rappresentassimo il Cyrano de Bergerac? 
                Aldo: Ma Giacomino, Giacomino, sempre con queste americanate, finiscila, va! 
                Giacomo: Americanate che cosa?! È francese, il Cyrano! 
                Aldo: C'hai sempre ragione tu...", 4 },
                    { 48, @"Giacomo: C'ho un turno di doppiaggio, Aldo. 
                ...
                Giacomo: Eh, vai! 
                Aldo [triste per ciò che stava per succedere]: Giovanni, fallo tu, ti prego... [Giovanni si rassegna] Grazie! [lo bacia]", 4 },
                    { 49, @"Giacomo: Va' che non ci vuole niente a scaricare le donne degli altri. L'unica cosa veramente importante è che non la lasci parlare: non deve avere il tempo di parlare. Devi essere lucido, freddo, distaccato. 
                Giovanni: Tipo Zoff? 
                Giacomo: Mmh, tipo Zoff.", 4 },
                    { 50, @"[Pensando a una terza persona per la cena]
                ...
                Giacomo: Ma dai Giova, era uno scherzo!", 4 },
                    { 51, @"[Parlando della cena a tre, al supermercato]
                ...
                Giovanni: Lascia perdere, cosa ne sai tu di economia, Giacomo?", 4 },
                    { 52, @"Aldo: Continuiamo, va'. Fuori dal letto...? Fuori dal letto? 
                Giacomo: Nessuno è perfetto. 
                Aldo [urlando]: Nessuna pietà! Nessuna pietà! Ma come devo fare con te? Attitudini sull'amore nessuna! [mentre camminano per i reparti di un supermercato, Aldo cerca di spiegare a Giacomo come deve trattare una donna seguendo una nota canzone di Marco Ferradini, di cui Giacomo non riesce a ricordare le parole]", 4 },
                    { 53, @"Marina: Giovanni, non senti uno strano odore?
                Giovanni: Di cosa?
                Marina: Di bruciato?
                Giovanni: Ah sì è vero, c'è l'arrosto nel forno.
                Aldo: Lo sento pure io. 
                Silvana: No no, io non sento proprio odore di bruciato. 
                Aldo: Eh, c'avrai le mucose andate...", 4 },
                    { 65, @"Zia di Aldo: Spero solo di sentire presto gli zoccoli del cavallo di San Bartolomeo. 
                ...
                Giovanni: Ah questo è ottimismo? Chissà il resto...", 4 },
                    { 54, @"Beppe il ladro: Dammi il portafoglio!
                Aldo: Ok, ma non mi puntare l'arma addosso.
                Beppe il ladro [prende e apre il portafoglio]: Ma è vuoto?!
                Aldo: Eh, tu il portafoglio mi hai chiesto...", 4 },
                    { 56, @"Giovanni Ciao Beppe! 
                ...
                Beppe: Aah... 
                Giovanni: Eh, ""aah""... E intanto, eh, track! Ti ci sei affezionato! Ecco, Beppe, cerca di perdere il vizio, eh!", 4 },
                    { 57, @"Giacomo: Giovanni guarda, non so proprio come dirtelo, ma i mobili di tua madre fan veramente cagare. 
                ...
                Giovanni: Non è un proverbio, è la vita, Giacomo.", 4 },
                    { 58, @"Giacomo: Abbiamo incontrato Francesca che piangeva! Cosa le hai fatto? 
                Aldo: Niente! 
                ...
                Aldo: Sì...
                Giacomo: Certo che tu sei veramente il campione olimpico dei minchioni!", 4 },
                    { 59, @"Giacomo: Be', immagino Elena che tu abbia già avuto esperienze teatrali...
                Candidata attrice: Io sì. E voi?
                [I tre si guardano imbarazzati]
                Giacomo: Comunque la commedia sarebbe il Cyrano di Bergerac.
                Aldo: Sì, Bergerac... Che sarebbe anche l'autore. [la candidata se ne va]", 4 },
                    { 60, @"Giacomo: Immagino che tu abbia già avuto esperienze di teatro... 
                Candidata attrice: Be', sì... ho lavorato con Albertazzi... 
                Aldo: Però... Albertazzi... il grande Albertazzi... il grande e irreprensibile Albertazzi! Mammamia, non sapevo che facesse anche teatro. [la candidata se ne va]", 4 },
                    { 61, @"Giacomo: Certo che è una situazione kafkiana... 
                Aldo: Ma, precisamente, questo Kafkian, chi è?", 4 },
                    { 62, @"Giovanni [al venditore di snack sul treno]: Che tipo di panini avete? 
                ...
                Venditore: Certo. [prende il panino e lo mette contro il finestrino su cui batte il sole] Se ha una mezz'oretta...", 4 },
                    { 63, @"Giovanni: Io ero a Francoforte, e tu l'hai baciata!? 
                ...
                Giovanni: La commedia?! Guarda la tua commedia, guarda... [prende una spada di legno e comincia a distruggere tutta la scenografia con rabbia] Eccola! Guarda la tua commedia! La commedia del cazzo!!! [butta giù un albero della scenografia e se ne va]", 4 },
                    { 55, @"Giacomo: Smettila di buttarti giù, quante volte te lo devo dire, vedrai che va tutto a posto! Del resto tu sei un ragazzo intelligente, eh, si vede! 
                Beppe: Da cosa? 
                Giacomo: Beppe, son frasi fatte, è per dire... Non è che devi star lì ad approfondire tutto...", 4 },
                    { 175, @"Giacomo: Ludmilla! Una colonscopia al paziente ventitré! 
                Paziente: Ohhh, che super-io spigoloso! 
                Giacomo: Vedrà che colonscopia spigolosa!", 9 }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Dialogues_MovieId",
                table: "Dialogues",
                column: "MovieId");
        }
